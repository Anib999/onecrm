  ...
  return (
    <div className='invoice-form shipping-invoice'>
      <PageHeader
        ...
        shipmentDetail = {isPublished ? 'Shipment Detail' : ''}
        shipmentDetailButtonClick={() => window.open(`/settings/shipment/print1/${pid}`, "_blank")}
        
        shipmentInvoice = {isPublished ? 'Shipment Invoice ' : ''}
        shipmentInvoiceButtonClick={() => window.open(`/settings/shipment/print2/${pid}`, "_blank")}
      />
      <Card>
                ...
                >
                  <Descriptions.Item label="Date of issue">
                    {!isPublished ?
                      ...
                      {/* {console.log('date of issues',dateOfIssue)} */}
